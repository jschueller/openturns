...
The model is approximated by the meta model defined in :ref:`functional_chaos` by equation :eq:`metaModelPn` and the coefficients :math:`(\alpha_k)_{k \in I_n}` are computed by solving the least squares problem defined in :ref:`functional_chaos` by equation :eq:`metaModeleF`.
