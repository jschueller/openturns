...
# %%
instrumental = [ot.Uniform(-5., 5.), ot.Uniform(-1., 1.), ot.Uniform(-1., 1.)]
...
mh_coll = [ot.RandomWalkMetropolisHastings(prior, initialState, instrumental[i], [i]) for i in range(paramDim)]
