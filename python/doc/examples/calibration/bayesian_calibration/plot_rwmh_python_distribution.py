...
# - An instrumental distribution used to update parameters.
#
...
instrumental = ot.ComposedDistribution(proposal)
...
sampler2 = ot.RandomWalkMetropolisHastings(logpdf, support, initialState, instrumental)
