...
prior_string = {ot.GeneralLinearModelAlgorithm.NONE: 'none',
                ot.GeneralLinearModelAlgorithm.JOINTLYROBUSTPRIOR: 'jointlyrobust',
                ot.GeneralLinearModelAlgorithm.REFERENCEPRIOR: 'reference'}
...
with open('gu.tex', 'w') as tex:
    ...
    for covarianceModel in covModels:
        ...
        for prior in [ot.GeneralLinearModelAlgorithm.NONE, ot.GeneralLinearModelAlgorithm.JOINTLYROBUSTPRIOR, ot.GeneralLinearModelAlgorithm.REFERENCEPRIOR]:
